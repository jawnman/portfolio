    ...
    return (
        <section id="about" className="py-20 px-4 max-w-7xl mx-auto flex flex-col md:flex-row gap-12 items-start">
            <div className="w-full md:w-1/3 md:sticky md:top-24">
                <div className="relative aspect-[3/4] overflow-hidden bg-black tech-border">
                    <img
            ...
            <div className="w-full md:w-2/3">
                ...
                >
                    <h2 className="font-display text-4xl md:text-6xl font-semibold tracking-tight text-tech-accent mb-8">
                        About
                    </h2>

                    <div className="space-y-6 font-light text-lg text-tech-secondary mb-12">
                        ...
                        <p className="leading-relaxed">
                            My work lives between real and surreal: clean, emotional, and built to feel like a moment you can step back into. Whether I’m shooting a show, documenting a weekend on the road, or building a full recap from scratch, I focus on <span className="text-tech-accent font-medium">atmosphere, story, and detail.</span>
                        </p>
                        <p className="leading-relaxed">
                    ...
                    <h3 className="font-display text-2xl font-semibold tracking-tight text-tech-accent mb-6 border-b border-tech-muted/60 pb-2">
                        Experience
                    </h3>
                        ...
                        {experience.map((job, index) => (
                            <div key={index} className="group">
                                <div className="flex flex-col md:flex-row md:items-baseline md:justify-between mb-2">
                                    <h4 className="text-xl font-medium text-tech-accent group-hover:text-tech-primary transition-colors">{job.role}</h4>
                                    <span className="text-tech-secondary text-sm">{job.period}</span>
                                </div>
                                <h5 className="text-tech-primary mb-3">{job.company}</h5>
                                <ul className="space-y-2">
                                    {job.details.map((detail, i) => (
                                        <li key={i} className="flex items-start gap-3 text-sm text-tech-secondary">
                    ...
                    <div className="pt-12">
                        <a href="mailto:nickroehmxyz@gmail.com" className="inline-block px-8 py-3 bg-tech-primary text-black font-medium text-sm tracking-wide hover:bg-white transition-colors">
                            Get in Touch
                        </a>
                    </div>
                </motion.div>
